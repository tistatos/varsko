	...
	<div class="col-md-6">
		...
		<div class="tab-content">
				...
				<div class="row">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="Vart" class="form-control" id="inputVart" placeholder="Var">
							</div>
						</div>
						<div class="form-group">
			...
			<div role="tabpanel" class="tab-pane" id="veri">
				...
				<button href="#klar" style="float: right" aria-controls="messages" role="tab" data-toggle="tab" class="btn btn-danger btn-next" type="submit">Anmäl</button>
